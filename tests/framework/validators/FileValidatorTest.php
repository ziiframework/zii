...
class FileValidatorTest extends TestCase
{
    ...
    public function testValidateAttributeMultiple(): void
    {
        ...
        $this->assertSame(array_keys($m->attr_files), array_keys($files));
    ...
    public function testValidateMimeTypeCaseInsensitive($mask, $fileMimeType, $expected): void
    {
        ...
        $this->assertSame($expected, $validator->validate($file), sprintf('Mime type validate fail: "%s" / "%s"', $mask, $fileMimeType));
    }
