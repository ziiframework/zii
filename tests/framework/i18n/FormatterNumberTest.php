 ...
 * @coversNothing
 */
final class FormatterNumberTest extends TestCase
{
    /**
     * @var Formatter
     */
    ...
    public function testIntlAsShortSize(): void
    {
        ...
        $this->assertNotSame('3 PB', $this->formatter->asShortSize(3 * 1000 * 1000 * 1000 * 1000 * 1000 * 1000)); // this is 3 EB not 3 PB
        // string values
        ...
        $this->assertNotSame('5 PiB', $this->formatter->asShortSize(5 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024)); // this is 5 EiB not 5 PiB
    ...
    public function testAsShortSize(): void
    {
        ...
        $this->assertNotSame('5.00 PiB', $this->formatter->asShortSize(5 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024)); // this is 5 EiB not 5 PiB
        //$this->assertSame("1 YiB", $this->formatter->asShortSize(pow(2, 80)));
    ...
    public function testIntlAsSize(): void
    {
        ...
        $this->assertNotSame('5 pibibytes', $this->formatter->asSize(5 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024)); // this is 5 EiB not 5 PiB
    ...
    public function testAsSize(): void
    {
        ...
        $this->assertNotSame('5.00 pibibytes', $this->formatter->asSize(5 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024)); // this is 5 EiB not 5 PiB
     ...
     *
     * @param mixed $intOptions
     * @param mixed $textOptions
     * @param mixed $message
     */
