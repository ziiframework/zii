 ...
 * @coversNothing
 */
final class DeadLockTest extends \yiiunit\framework\db\mysql\ConnectionTest
{
    ...
    public function testDeadlockException(): void
    {
        ...
        $this->assertSame(1, $deadlockHitCount, "exactly one child must hit deadlock; shared children log:\n" . $logContent);
    }
     ...
     *
     * @return null|string String content of the file [[logFile]]. `false` is returned
