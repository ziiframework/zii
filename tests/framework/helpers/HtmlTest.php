...
<li>Error message. Here are even more chars: &quot;&quot;</li></ul></div>',
    ...
    public function testError(): void
    {
        ...
        $this->assertEquals('<div>Error in yiiunit\framework\helpers\HtmlTestModel - name</div>', Html::error($model, 'name', ['errorSource' => static fn ($model, $attribute) => 'Error in ' . $model::class . ' - ' . $attribute]), 'Custom error message generated by closure');
    }
