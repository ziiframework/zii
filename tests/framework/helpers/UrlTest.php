...
final class UrlTest extends TestCase
{
    ...
    public function testCurrent(): void
    {
        ...
        $this->assertSame($uri . '&id=10&name=test&10=0', Url::current());
        $this->assertSame($uri . '&id=20&name=test&10=0', Url::current(['id' => 20]));
        $this->assertSame($uri . '&name=test&10=0', Url::current(['id' => null]));
        $this->assertSame($uri . '&name=test&10=0&1=yes', Url::current(['id' => [], 1 => 'yes']));
        $this->assertSame($uri . '&name=test&10=0', Url::current(['id' => []]));
        $this->assertSame($uri . '&name=test', Url::current(['id' => null, 10 => null]));
        $this->assertSame($uri . '&name=test&1=yes', Url::current(['id' => null, 10 => null, 1 => 'yes']));

        $params = ['arr' => ['attr_one' => 1, 'attr_two' => 2]];
        Yii::$app->request->setQueryParams($params);

        $this->assertSame($uri . '&arr%5Battr_one%5D=1&arr%5Battr_two%5D=2', Url::current());
        $this->assertSame($uri, Url::current(['arr' => null]));
        $this->assertSame($uri . '&arr%5Battr_two%5D=2', Url::current(['arr' => ['attr_one' => null]]));
        $this->assertSame($uri . '&arr%5Battr_one%5D=1&arr%5Battr_two%5D=two', Url::current(['arr' => ['attr_two' => 'two']]));
    }
